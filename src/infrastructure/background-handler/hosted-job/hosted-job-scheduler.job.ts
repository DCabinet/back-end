...
@Injectable()
export class HostedJobSchedulerService implements OnModuleInit {
   constructor(
      ...
      this.logger.setContext(HostedJobSchedulerService.name);
   }

   async onModuleInit() {
      this.logger.log('HostedJobSchedulerService initialized');
